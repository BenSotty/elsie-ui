// Define here Elsie random contents descriptions and options
// See randomize-content.js component
window.elsie = window.elsie || {};
window.elsie.randomContents = window.elsie.randomContents || {}
window.elsie.randomContents.loginPage = {
  options: {
